...
def load_data(columns):
    ...
    sql = "SELECT "+select_columns+" FROM var_radial_chicago WHERE dec21 IS NOT NULL ORDER BY june21;"
...
model_file = 'trained_nn_chi_dec21.sav'
scale_file = 'scale_chi_dec21.sav'
