...
def load_data(columns):
    ...
    sql = "SELECT "+select_columns+" FROM var_radial_buffer_sky_exposure_temp WHERE sep22 IS NOT NULL ORDER BY june21;"
...
model_file = 'trained_nn_la_sep22.sav'
scale_file = 'scale_la_sep22.sav'
