...
def load_data(columns):
    ...
    sql = "SELECT "+select_columns+" FROM var_radial_buffer_sky_exposure_temp WHERE dec21 IS NOT NULL ORDER BY june21;"
...
model_file = 'trained_nn_ny_dec21.sav'
scale_file = 'scale_ny_dec21.sav'
