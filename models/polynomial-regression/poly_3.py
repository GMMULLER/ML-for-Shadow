...
sql = "SELECT exposure,heightroof_sum,groundelev_sum,june21 FROM complete_sky_exposure WHERE exposure IS NOT NULL AND heightroof_sum IS NOT NULL AND groundelev_sum IS NOT NULL june21 IS NOT NULL;"
...
for linha in resultado:
    ...
    col3.append(float(linha[2]))

d = {colnames[0]:col1, colnames[1]:col2, colnames[2]:col3}
...
print('Root Mean Square Error: %.2f' % mean_squared_error(Y_test, y_pred, squared=False))
